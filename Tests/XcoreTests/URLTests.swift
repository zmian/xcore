...
struct URLTests {
    @Test
    func queryItem() throws {
        let url = try #require(URL(string: "https://example.com/?q=HelloWorld"))
        #expect(url.queryItem(named: "q") == "HelloWorld")
        #expect(url.queryItem(named: "x") == nil)
    }

    @Test
    func removingFragment() throws {
        let url1 = try #require(URL(string: "https://example.com/#hero"))
        #expect(url1.removingFragment() == URL(string: "https://example.com/")!)

        let url2 = try #require(URL(string: "https://example.com#hero"))
        #expect(url2.removingFragment() == URL(string: "https://example.com")!)

        // Unchanged url.
        let url3 = try #require(URL(string: "https://example.com/?q=HelloWorld"))
    ...
    @Test
    func removingScheme() throws {
        let url1 = try #require(URL(string: "https://www.example.com/?q=HelloWorld"))
        let url2 = try #require(URL(string: "http://welcome.hello.example.com/?q=HelloWorld"))
        let url3 = try #require(URL(string: "www.hello.example.com/?q=HelloWorld"))
        let url4 = try #require(URL(string: "hello.example.com"))
        let url5 = try #require(URL(string: "mail.app"))
        let url6 = try #require(URL(string: "file://mail.app"))
        let url7 = try #require(URL(string: "mailto://mail.app"))
    ...
    @Test
    func removingQueryItems() throws {
        let url1 = try #require(URL(string: "https://www.example.com/?q=HelloWorld"))
        let url2 = try #require(URL(string: "http://welcome.hello.example.com/?q=HelloWorld&lang=swift"))
        let url3 = try #require(URL(string: "www.hello.example.com/?q=HelloWorld"))
        let url4 = try #require(URL(string: "hello.example.com"))
        let url5 = try #require(URL(string: "mail.app"))
        let url6 = try #require(URL(string: "file://mail.app"))
    ...
    @Test
    func removingQueryItemsList() throws {
        let url1 = try #require(URL(string: "https://www.example.com/?q=HelloWorld"))
        let url2 = try #require(URL(string: "http://welcome.hello.example.com/?q=HelloWorld&lang=swift"))
        let url3 = try #require(URL(string: "www.hello.example.com/?q=HelloWorld"))
        let url4 = try #require(URL(string: "hello.example.com"))
        ...
        let url6 = try #require(URL(string: "file://mail.app"))
        let url7 = try #require(URL(string: "mailto://mail.app"))
        let url8 = try #require(URL(string: "https://www.example.com/?q=HelloWorld"))
    ...
    @Test
    func removingQueryItemNamed() throws {
        let url1 = try #require(URL(string: "https://www.example.com/?q=HelloWorld"))
        let url2 = try #require(URL(string: "http://welcome.hello.example.com/?q=HelloWorld&lang=swift"))
        let url3 = try #require(URL(string: "www.hello.example.com/?q=HelloWorld"))
        let url4 = try #require(URL(string: "hello.example.com"))
    ...
    @Test
    func replacingQueryItemNamed() throws {
        let url1 = try #require(URL(string: "https://www.example.com/?q=HelloWorld"))
        let url2 = try #require(URL(string: "http://welcome.hello.example.com/?q=HelloWorld&lang=swift"))
        let url3 = try #require(URL(string: "www.hello.example.com/?q=HelloWorld"))
        let url4 = try #require(URL(string: "hello.example.com"))
    ...
    @Test
    func replacingQueryItemsList() throws {
        let url1 = try #require(URL(string: "https://www.example.com/?q=HelloWorld"))
        let url2 = try #require(URL(string: "http://welcome.hello.example.com/?q=HelloWorld&lang=swift"))
        let url3 = try #require(URL(string: "www.hello.example.com/?q=HelloWorld"))
        let url4 = try #require(URL(string: "hello.example.com"))
    ...
    @Test
    func maskingAllQueryItems() throws {
        let url1 = try #require(URL(string: "https://www.example.com/?q=HelloWorld"))
        let url2 = try #require(URL(string: "http://welcome.hello.example.com/?q=HelloWorld&lang=swift"))
        let url3 = try #require(URL(string: "www.hello.example.com/?q=HelloWorld"))
        let url4 = try #require(URL(string: "hello.example.com"))
    ...
    @Test
    func appendingQueryItemsList() throws {
        let url1 = try #require(URL(string: "https://www.example.com/?q=HelloWorld"))
        let url2 = try #require(URL(string: "http://welcome.hello.example.com/?q=HelloWorld&lang=swift"))
        let url3 = try #require(URL(string: "www.hello.example.com/?q=HelloWorld"))
        let url4 = try #require(URL(string: "hello.example.com"))
    ...
    @Test
    func matchFound() throws {
        let domain = "example.com"
        let url1 = try #require(URL(string: "https://www.example.com/?q=HelloWorld"))
        let url2 = try #require(URL(string: "https://example.com/?q=HelloWorld"))
        let url3 = try #require(URL(string: "https://hello.example.com/?q=HelloWorld"))
        let url4 = try #require(URL(string: "https://welcome.hello.example.com/?q=HelloWorld"))
        ...
        // Org
        let url6 = try #require(URL(string: "https://example.org"))
        let url7 = try #require(URL(string: "example.org"))
    ...
    @Test
    func matchNotFound() throws {
        let domain = "example.com"
        let url1 = try #require(URL(string: "https://www.examplex.com/?q=HelloWorld"))
        let url2 = try #require(URL(string: "https://example_x.com/?q=HelloWorld"))
        let url3 = try #require(URL(string: "https://hello.example-x.com/?q=HelloWorld"))
        let url4 = try #require(URL(string: "https://welcome.hello.helloexample.com/?q=HelloWorld"))
        let url5 = try #require(URL(string: "https://example.org"))
    ...
    @Test
    func maskingSensitiveQueryItems() throws {
        FeatureFlag.resetProviders()
        FeatureFlag.setValue(["token", "vfp"], forKey: "sensitive_url_query_parameters")
        let url1 = try #require(URL(string: "https://example.com/magiclink?token=Jn3yk23cf23"))
        let url2 = try #require(URL(string: "https://example.com/magiclink?token=Jn3yk23cf23"))
        let url3 = try #require(URL(string: "https://app.example.com/magiclink?token=Jn3yk23cf23"))
        let url4 = try #require(URL(string: "https://example.com/callback/prove?vfp=Jn3yk23cf23"))
        let url5 = try #require(URL(string: "https://app.example.com/magiclink?vfp=Jn3yk23cf23&token=Jn3yk23cf23"))
        let url6 = try #require(URL(string: "https://app.example.com/magiclink?token=Jn3yk23cf23&vfp=Jn3yk23cf23"))
        let url7 = try #require(URL(string: "https://example.com/dl/trade/buy?id=20"))
        let url8 = try #require(URL(string: "https://example.com/dl/trade/buy?id=20&token=Jn3yk2x3cf23"))
        let url9 = try #require(URL(string: "https://example.com/buy?token=Jn3yk2x3cf23"))
        let url10 = try #require(URL(string: "https://example.com?token=Jn3yk2x3cf23"))
        let url11 = try #require(URL(string: "https://example.com?code=Jn3yk2x3cf23"))
    ...
    func resolvingRedirectedLink() async throws {
        let shortUrl = try #require(URL(string: "https://git.new/swift"))
