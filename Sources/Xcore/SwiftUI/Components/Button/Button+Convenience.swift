...
extension Button<Text> {
    ...
    public static func okay(action: @escaping @MainActor () -> Void) -> some View {
    ...
    public static func no(action: @escaping @MainActor () -> Void) -> some View {
        Button(L.no, action: action)
            .accessibilityIdentifier("noButton")
    }

    /// A button with `Submit` label and given action.
    public static func submit(action: @escaping @MainActor () -> Void) -> some View {
        Button(L.submit, action: action)
            .accessibilityIdentifier("submitButton")
    }

    /// A button with `Done` label and given action.
    public static func done(action: @escaping @MainActor () -> Void) -> some View {
    ...
    public static func openAppSettings(action: @escaping @MainActor () -> Void) -> some View {
    ...
    public static func track(action: @escaping @MainActor () -> Void) -> some View {
        Button(L.track, action: action)
            .accessibilityIdentifier("trackButton")
    }

    /// A button with `Start` label and given action.
    public static func start(action: @escaping @MainActor () -> Void) -> some View {
        Button(L.start, action: action)
            .accessibilityIdentifier("startButton")
    }

    /// A button with `Share` label and given action.
    public static func share(action: @escaping @MainActor () -> Void) -> some View {
        Button(L.share, action: action)
            .accessibilityIdentifier("shareButton")
    }

    /// A button with `Sign Up` label and given action.
    public static func signup(action: @escaping @MainActor () -> Void) -> some View {
...
extension Button<Label<Text, Image>> {
    ...
    public static func dismiss(action: @escaping @MainActor () -> Void) -> some View {
...
extension Button<EitherAnyViewText> {
    ...
    /// given action.
    public static func learnMore(withChevron: Bool = true, action: @escaping @MainActor () -> Void) -> some View {
    ...
    /// given action.
    public static func readMore(withChevron: Bool = true, action: @escaping @MainActor () -> Void) -> some View {
    ...
    public static func seeMore(withChevron: Bool = true, action: @escaping @MainActor () -> Void) -> some View {
    ...
    public static func seeMore(withChevron: Bool = true, toggled: Bool, action: @escaping @MainActor () -> Void) -> some View {
        menu(
    ...
    public static func seeAll(withChevron: Bool = true, action: @escaping @MainActor () -> Void) -> some View {
    ...
    public static func seeAll(withChevron: Bool = true, toggled: Bool, action: @escaping @MainActor () -> Void) -> some View {
        menu(
