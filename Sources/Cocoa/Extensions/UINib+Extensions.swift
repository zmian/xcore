...
extension UINib {
    /// A optional initializer to return a `UINib` object initialized to the nib
    /// file in the specified bundle or in `main` bundle if no bundle is provided.
    ///
    /// - Parameters:
    ///   - named: The name of the nib file, without any leading path information.
    ///   - bundle: The bundle in which to search for the nib file. If you specify
